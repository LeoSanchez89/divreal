...
const PrivacyPolicy = () => {
	const title = "Cards & Tankards - Privacy Policy";
	return (
		<Layout title={title}>
			<section className="max-w-screen-xl mx-auto px-6 pt-28 pb-16 sm:pb-40">
				<header>
					<h1 className="text-4xl sm:text-5xl 2xl:text-6xl font-bold py-2">
						Privacy Policy
					</h1>
					<p className="font-semibold 2xl:text-lg py-2">
				...
				<div>
					...
					<div>
						<h3 className="text-2xl sm:text-3xl 2xl:text-4xl font-bold">
							Interpretation
						</h3>
						<p className="pb-2">
					...
					<div>
						<h3 className="text-2xl sm:text-3xl 2xl:text-4xl font-bold pt-4">
							Definitions
						</h3>
						...
						<ul className="list-disc pl-9 pb-2">
							...
							<li>
								<strong>Website</strong> refers to Divergent Realities,
								accessible from{" "}
								<a
									href="https://www.divergent-realities.com/"
									className="text-blue-600 underline"
								>
									https://www.divergent-realities.com/
								</a>
							</li>
							<li>
				...
				<div>
					...
					<div>
						<h3 className="text-2xl sm:text-3xl 2xl:text-4xl font-bold py-2">
							Types of Data Collected
						</h3>
						<div>
							<div>
								<h4 className="text-xl sm:text-2xl 2xl:text-3xl font-bold pt-2">
									Personal Data
								</h4>
								<p>
							...
							<div>
								...
								<p className="pb-2">
									...
									a report by you or another user, pertaining to an incident or
								...
								<p className="pb-2">
									...
									recordings related to the same event. In such instances, we
									may gather and retain these shared audio recordings to conduct
									a comprehensive investigation into the reported matter.
								</p>
								<p className="pb-2">
									Once the investigative process is concluded, and the reported
									matter has been addressed, all relevant audio recordings
									obtained during the investigation phase will be deleted from
									our systems. However, legal requirements may necessitate the
									extended retention of audio data on our secured servers. In
									such cases, we diligently ensure that your privacy rights are
									upheld to the fullest extent permitted by applicable law.
								</p>
							</div>
							<div>
								<h4 className="text-xl sm:text-2xl 2xl:text-3xl font-bold pt-2">
								...
								<ul className="list-disc pl-9 py-2">
									<li>
					...
					<div>
						<h3 className="text-2xl sm:text-3xl 2xl:text-4xl font-bold py-4">
					...
					<div>
						...
						<div>
							<div>
								<h4 className="text-xl sm:text-2xl 2xl:text-3xl font-bold">
				...
				<div>
					...
					<p>
						...
						via email at the contact below.
					</p>
				</div>
				<div>
					<h2 className="text-3xl sm:text-4xl 2xl:text-5xl font-bold py-4">
				...
				<div>
					...
					<ul className="list-disc pl-9 py-2">
						<li>
							By email:{" "}
							<a
								href="mailto:contact@divergent-realities.com?subject=Message%20from%20divergent-realities.com"
								className="text-blue-600 underline"
							>
								contact@divergent-realities.com
							</a>
						</li>
					</ul>
				</div>
