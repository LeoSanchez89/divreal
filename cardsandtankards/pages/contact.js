...
const Contact = () => {
	...
	return (
		<Layout title={title}>
			<section className="pb-16 sm:pb-40 bg-slate-100">
				<header className="relative w-full h-[40vh] md:h-[50vh] subheader-bg">
					...
					<div className="absolute inset-x-0 bottom-0 md:-bottom-8 md:pb-2 lg:pb-0">
						<p className="text-white sm:font-semibold 2xl:text-lg text-center max-w-prose mx-auto px-6 pb-6 md:p-0 ">
							We're here for you! Our dedicated team is committed to resolving
							any issues or inquiries you may have. Send us a message below.
						</p>
					</div>
				</header>
				...
				<div className="mt-10 md:mt-20 mx-6 px-6 py-8 md:p-14 max-w-screen-md md:mx-auto border bg-white shadow-md rounded">
					<form
					...
					>
						<div className="md:flex md:justify-between md:gap-x-8 md:mb-4">
							<div className="flex flex-col mb-4 w-full">
								...
								<input
									...
									autoComplete="off"
									required
									className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-orange-200 focus:shadow-outline"
								/>
							</div>
							<div className="flex flex-col mb-4 w-full">
								<label
						...
						<div className="md:flex md:justify-center">
							...
							<button
								type="submit"
								className="w-full md:w-2/5 bg-amber-800 text-white font-bold py-2 px-4 rounded hover:ease duration-300 hover:border hover:border-amber-500 hover:shadow-lg hover:shadow-amber-700/50 hover:bg-amber-700"
							>
								Send Message
							</button>
						</div>
