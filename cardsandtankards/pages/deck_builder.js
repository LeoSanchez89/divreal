...
const DeckBuilder = () => {
	...
	// array of all collectible cards with an ID sorted by mana cost
	const allCards = cardData.AllCardDatas
		.filter((card) => card.Id && card.Collectible) 
		.sort((a, b) => a.ManaCost - b.ManaCost); 


	// filter state
	const initialState = { manaCost: "", faction: "2" };
	...
	const filteredCards = filterCards(allCards, "", filter);
